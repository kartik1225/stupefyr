<template>
	<div class="rocket" :style="$vuetify.breakpoint.width<600?`width:100px;`:`width:200px`">
  <div class="sky" >
  ...
  <svg  version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   viewBox="0 0 500 556.726" :style="`enable-background:new 0 0 500 556.726; ${$vuetify.breakpoint.width<600?`width:100px;`:`width:200px`}`" xml:space="preserve">
<g>
  <g>
    <defs>
  ...
  <g>
    ...
    <path style="clip-path:url(#SVGID_4_);" fill="#37474F"d="M343.238,172.072c-11.457-11.457-26.687-17.766-42.89-17.766
